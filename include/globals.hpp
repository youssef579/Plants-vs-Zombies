...
struct Sun {
  ...
  float fadeFactor;   //Rate of fading according to initial distance (to prevent sudden fades)
};
...
float updateSlider(Slider& slider); //Updates then Returns slider value ranged (0->100)
